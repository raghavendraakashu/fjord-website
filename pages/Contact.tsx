          ...
          <div className="lg:col-span-7">
            <div className="bg-slate-50 p-10 md:p-16 rounded-[3rem] border border-slate-100">
              {submitted ? (
                ...
                >
                  <div className="w-20 h-20 bg-blue-600 text-white rounded-3xl flex items-center justify-center mb-10 shadow-lg rotate-3">
                    <CheckCircle size={40} />
                  </div>
                  <h2 className="text-3xl font-bold text-slate-950 mb-6 tracking-tight">Inquiry Received</h2>
                  <p className="text-slate-500 max-w-xs mx-auto font-light leading-relaxed">
                    Thank you for your message. Our engineering leads will review your brief and respond within 48 hours.
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    className="mt-12 text-slate-950 font-black uppercase tracking-ultra text-[10px] hover:text-blue-600 transition-colors"
                  >
                    Resubmit Form
                  </button>
                </motion.div>
